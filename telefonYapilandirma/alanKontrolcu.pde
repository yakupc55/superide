...
// alan kotnrolcüsünün özel yapılandırma yapıları üzerinden bir çalışma performansı içinde olabilir burasını kestirmekte çeşitli 
// zorluklarla karşılaşabiliriz.
final boolean telefonYapilandirma=false;
...
ArrayList<ozelAlan> ozelAlanlar=new ArrayList<ozelAlan>();

// alan kontrolcüsü için bazı durumlarda ekran yakınlaştırma ve uzaklaştırma durumları için çeşitli yapılandırmalar
float xKayma=0;
float yKayma=0;
 ...
 //sisteme ana alanı eklemiş oluyoruz.   
  ...
  void ozelElemanEkle(ozelAlan gelen){
   ozelAlanlar.add(gelen);
  }
  
  void ozelElamanlarTemizle(){
  ozelAlanlar.clear();  
  }
